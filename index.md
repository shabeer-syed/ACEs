...
3. To apply multiple rule-based algorithims (age critera, accident exclusions etc) and for faster implementation, more advanced [control flow methods](https://adv-r.hadley.nz/control-flow.html) are required. Control flow ("if then assumptions") are widley covered elsehwere [1](https://adv-r.hadley.nz/control-flow.html) [2](https://advanced-r-solutions.rbind.io/control-flow.html).
