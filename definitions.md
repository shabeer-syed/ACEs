...
The absence of consistent definititions, reference standards and theoretical frameworks, creates multiple challenges to developing new indicators of ACEs for electronic health records (EHRs).
To overcome previous limitations, we combined previously established theories into a collective "testable" and intergrated biopsychosocial framework to help explain and generate predictions of which ACE indicators might be more relevant than others. This page briefly summarises this intergrative model and reference standard that underpinned the development and validation of the ACE indicators. 
